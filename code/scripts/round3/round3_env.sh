...
ROUND3_DATA_DIR="${SOPPO_ROUND3_DATA_DIR:-$DATA_ROOT/round3/dual_source_v2}"
ROUND3_REFERENCE_DIR="${SOPPO_ROUND3_REFERENCE_DIR:-$CACHE_ROOT/round3/reference_qwen3_1.7b_dual_source_v2}"
