...
class SaveBestModelCallback(TrainerCallback):
    """
    Callback to save the model with the lowest eval_loss
    """
    ...
    def on_evaluate(self, args, state, control, metrics=None, **kwargs):
        ...
        if is_better:
            ...
            print(f"Save the new best model... {self.metric_name} = {metric_value}")
...
def run_dpo(
    ...
    save_best_callback = SaveBestModelCallback(metric_name="eval_loss", greater_is_better=False)
